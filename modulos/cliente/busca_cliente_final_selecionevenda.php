...
if ($db->num_rows ( $query )) {
	...
	while ( $rows = $db->fetch_assoc ( $query ) ) {
		...
		$table .= '<td width="5"></td>';
		$table .= '<td width="80" align="center"><input type="button" onclick="javascript:carregar_cliente_finalselecionadoparavenda(\'' . $rows ['idcliente'] . '\', \'' . ucwords ( strtolower ( $rows ['txtnome'] ) ) . '\');" value="selecionar" style="cursor:pointer;cursor:hand;color:black" onmouseover="javascript:this.style.background=\'#6aa9e9\';this.style.color=\'white\';" onmouseout="javascript:this.style.background=\'#FFFFFF\';this.style.color=\'black\';"></td>';
		$table .= '<td width="80" align="center"><input type="button" onclick="javascript:carregar_cliente_finalselecionadodetalhes(\'' . $rows ['idcliente'] . '\');" value="detalhes" style="cursor:pointer;cursor:hand;color:black" onmouseover="javascript:this.style.background=\'#6aa9e9\';this.style.color=\'white\';" onmouseout="javascript:this.style.background=\'#FFFFFF\';this.style.color=\'black\';"></td>';
