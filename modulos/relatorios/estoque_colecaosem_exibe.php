...
<?
	...
	<tr>
		...
		if ($db->num_rows ( $query )) {
			?>
			<a href="javascript:;" onclick="javascript:document.getElementById('colecao_<?=$rowcolecao ['idcolecao'];?>').style.display = ((document.getElementById('colecao_<?=$rowcolecao ['idcolecao'];?>').style.display=='none')?'block':'none');"><b><?=ucwords ( strtolower ( $rowcolecao ['txtnome'] ) );?> - <?=$rowcolecao ['txtperiodo'];?></b></a>
			<?
		} else {
			?>
